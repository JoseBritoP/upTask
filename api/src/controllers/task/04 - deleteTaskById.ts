...
export const deleteTaskById = async (id:string,creatorId:any) => {
  ...
  if(proyect.creator?.toString() !== creatorId.toString()) throw new Error(`Unauthorized to delete this task`);
