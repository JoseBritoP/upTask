...
const Aside = () => {
  ...
  return (
    <aside className=" flex flex-col justify-center md:justify-start items-center w-full md:w-60 lg:w px-4 py-8  bg-gray-400 text-gray-50 md:border-black dark:bg-slate-700 border-b-2 dark:border-gray-400 md:border-r-2 md:border-b-0">
