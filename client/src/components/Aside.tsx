...
const Aside = () => {
  ...
  return (
    <aside className="w-full md:w-80 lg:w-96 px-5 py-6  bg-gray-400 text-gray-50 md:border-black dark:bg-slate-700 border-b-2 dark:border-gray-400 md:border-r-2">
