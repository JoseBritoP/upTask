...
const FormProyect = () => {
  ...
  return (
    <form action="" className="w-full lg:w-2/3 md:w-5/6 my-2 bg-white shadow rounded-lg px-5 py-2 pb-4 border-2 dark:bg-slate-950 dark:border-gray-700 dark:border-2" onSubmit={formik.handleSubmit}>      
      {/* Username */}
      <div className="my-5">
      ...
      <div className="my-5">
        ...
        <textarea
          ...
          className="w-full mt-3 p-3 border rounded-xl bg-gray-50 border-black dark:border-gray-500 dark:bg-gray-900 dark:placeholder:text-gray-300 dark:text-slate-100 resize-none"
          onChange={formik.handleChange}
          onBlur={formik.handleBlur}
      ...
      {/* Fecha de entrega */}
        <div className="my-5">
        <label htmlFor="limitdate" className="uppercase text-gray-600 block text-xl font-bold dark:text-gray-200 hover:cursor-pointer">Fecha limite</label>
        <input
          type="date" name="limitdate" id="limitdate"
          className="w-full mt-3 p-3 border rounded-xl bg-gray-50 border-black dark:border-gray-500 dark:bg-gray-900 dark:placeholder:text-gray-900 dark:text-slate-100"
          onChange={formik.handleChange}
          onBlur={formik.handleBlur}
          value={formik.values.limitdate}
        />
        {formik.touched.limitdate && formik.errors.limitdate && (
          <p className="text-red-500 font-semibold pt-2 dark:text-red-600">{formik.errors.limitdate}</p>
        )}
        </div>
        {/* client */}
        <div className="my-5">
        ...
        <input
          type="text" name="client" id="client" placeholder="Ingrese el nombre del cliente"
          className="w-full mt-3 p-3 border rounded-xl bg-gray-50 border-black dark:border-gray-500 dark:bg-gray-900 dark:placeholder:text-gray-300 dark:text-slate-100"
          onChange={formik.handleChange}
          onBlur={formik.handleBlur}
