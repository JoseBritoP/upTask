...
const NavbarClient = () => {
  ...
  return (
    <div className='pr-5 md:hidden'>
      ...
      {modal && (
        <div className='flex flex-col border-2 border-t-0 rounded-xl bg-sky-700 text-white dark:bg-sky-950 p-4 absolute top-10 right-0  md:hidden transition-all duration-200 ease-in-out sm:self-end'>
          <Link to={"/proyects"}>
